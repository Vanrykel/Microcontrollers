...
/* Pin_Switch */
#define Pin_Switch__0__INTTYPE CYREG_PICU1_INTTYPE2
#define Pin_Switch__0__MASK 0x04u
#define Pin_Switch__0__PC CYREG_PRT1_PC2
#define Pin_Switch__0__PORT 1u
#define Pin_Switch__0__SHIFT 2u
#define Pin_Switch__AG CYREG_PRT1_AG
#define Pin_Switch__AMUX CYREG_PRT1_AMUX
#define Pin_Switch__BIE CYREG_PRT1_BIE
#define Pin_Switch__BIT_MASK CYREG_PRT1_BIT_MASK
#define Pin_Switch__BYP CYREG_PRT1_BYP
#define Pin_Switch__CTL CYREG_PRT1_CTL
#define Pin_Switch__DM0 CYREG_PRT1_DM0
#define Pin_Switch__DM1 CYREG_PRT1_DM1
#define Pin_Switch__DM2 CYREG_PRT1_DM2
#define Pin_Switch__DR CYREG_PRT1_DR
#define Pin_Switch__INP_DIS CYREG_PRT1_INP_DIS
#define Pin_Switch__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Pin_Switch__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Pin_Switch__LCD_EN CYREG_PRT1_LCD_EN
#define Pin_Switch__MASK 0x04u
#define Pin_Switch__PORT 1u
#define Pin_Switch__PRT CYREG_PRT1_PRT
#define Pin_Switch__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Pin_Switch__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Pin_Switch__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Pin_Switch__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Pin_Switch__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Pin_Switch__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Pin_Switch__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Pin_Switch__PS CYREG_PRT1_PS
#define Pin_Switch__SHIFT 2u
#define Pin_Switch__SLW CYREG_PRT1_SLW
