// ======================================================================
// Bootloadable2.v generated from TopDesign.cysch
// 11/16/2017 at 15:12
...
module top ;
	...
	wire [0:0] tmpOE__Pin_StartBootloader_net;
	wire [0:0] tmpFB_0__Pin_StartBootloader_net;
	wire [0:0] tmpIO_0__Pin_StartBootloader_net;
	wire [0:0] tmpINTERRUPT_0__Pin_StartBootloader_net;
	electrical [0:0] tmpSIOVREF__Pin_StartBootloader_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4c15b41e-e284-4978-99e7-5aaee19bd0ce"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_StartBootloader
		 (.oe(tmpOE__Pin_StartBootloader_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_StartBootloader_net[0:0]}),
		  .io({tmpIO_0__Pin_StartBootloader_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_StartBootloader_net),
		  .interrupt({tmpINTERRUPT_0__Pin_StartBootloader_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_StartBootloader_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
