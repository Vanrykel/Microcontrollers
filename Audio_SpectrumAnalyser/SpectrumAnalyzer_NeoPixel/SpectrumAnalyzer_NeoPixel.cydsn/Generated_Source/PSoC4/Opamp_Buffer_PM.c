...
#if(!Opamp_Buffer_CHECK_DEEPSLEEP_SUPPORT)
    static Opamp_Buffer_BACKUP_STRUCT Opamp_Buffer_backup =
    {
        0u, /* enableState */
    };
#endif /* (Opamp_Buffer_CHECK_DEEPSLEEP_SUPPORT) */


/*******************************************************************************
* Function Name: Opamp_Buffer_SaveConfig
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Opamp_Buffer_RestoreConfig
********************************************************************************
*
* Summary:
*  Empty function. Included for consistency with other components.
...
/*******************************************************************************
* Function Name: Opamp_Buffer_Sleep
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  Opamp_Buffer_backup: The structure field 'enableState' is modified
...
{
#if(!Opamp_Buffer_CHECK_DEEPSLEEP_SUPPORT)
    if(Opamp_Buffer_CHECK_PWR_MODE_OFF)
    {
        Opamp_Buffer_backup.enableState = 1u;
        Opamp_Buffer_Stop();
    }
    else /* The component is disabled */
    {
        Opamp_Buffer_backup.enableState = 0u;
    }
#endif /* (Opamp_Buffer_CHECK_DEEPSLEEP_SUPPORT) */
}
...
/*******************************************************************************
* Function Name: Opamp_Buffer_Wakeup
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  Opamp_Buffer_backup: The structure field 'enableState' is used to
...
{
#if(!Opamp_Buffer_CHECK_DEEPSLEEP_SUPPORT)
    if(0u != Opamp_Buffer_backup.enableState)
    {
