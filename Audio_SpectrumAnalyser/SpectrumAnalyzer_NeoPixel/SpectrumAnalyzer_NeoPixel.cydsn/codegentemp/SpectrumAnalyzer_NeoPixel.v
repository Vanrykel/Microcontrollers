// ======================================================================
// SpectrumAnalyzer_NeoPixel.v generated from TopDesign.cysch
// 01/05/2020 at 17:33
...
`ifdef WARP
`define CY_BLK_DIR "C:\Users\Janni\OneDrive\Bureaublad\SpectrumAnalyzer_NeoPixel\StripLightLib.cylib\B_WS2811_v1_2"
`include "C:\Users\Janni\OneDrive\Bureaublad\SpectrumAnalyzer_NeoPixel\StripLightLib.cylib\B_WS2811_v1_2\B_WS2811_v1_2.v"
`else
`define CY_BLK_DIR "C:\Users\Janni\OneDrive\Bureaublad\SpectrumAnalyzer_NeoPixel\StripLightLib.cylib\B_WS2811_v1_2"
`include "C:\Users\Janni\OneDrive\Bureaublad\SpectrumAnalyzer_NeoPixel\StripLightLib.cylib\B_WS2811_v1_2\B_WS2811_v1_2.v"
`endif
...
// StripLights_v1_3(Channels=1, ClockSpeedKhz=800, Display_Memory=0, LEDs_per_Strip=40, Speed=1, Transfer_Method=1, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=StripLights_v1_3, CY_CONFIG_TITLE=StripLights, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=StripLights, CY_INSTANCE_SHORT_NAME=StripLights, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=3, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=StripLights, )
module StripLights_v1_3_2 (
    rdy,
    S0,
    S1,
    S2,
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=1, OutputCurrent=0, Power=2, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONFIG_TITLE=Opamp_Buffer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_Buffer, CY_INSTANCE_SHORT_NAME=Opamp_Buffer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Opamp_Buffer, )
...
module top ;
    ...
    ADC_SAR_SEQ_P4_v2_50_0 ADC_SAR (
        .Vref(Net_664),
        .sdone(Net_665),
        .eoc(Net_666),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__Audio_In_Neg_net;
	wire [0:0] tmpFB_0__Audio_In_Neg_net;
	wire [0:0] tmpIO_0__Audio_In_Neg_net;
	wire [0:0] tmpINTERRUPT_0__Audio_In_Neg_net;
	electrical [0:0] tmpSIOVREF__Audio_In_Neg_net;

	cy_psoc3_pins_v1_10
		#(.id("4605a049-78ef-4cc6-8d6e-569ac0354daf"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Audio_In_Neg
		 (.oe(tmpOE__Audio_In_Neg_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Audio_In_Neg_net[0:0]}),
		  .analog({Net_526}),
		  .io({tmpIO_0__Audio_In_Neg_net[0:0]}),
		  .siovref(tmpSIOVREF__Audio_In_Neg_net),
		  .interrupt({tmpINTERRUPT_0__Audio_In_Neg_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Audio_In_Neg_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_5 = Net_646 & Net_644;

    CyControlReg_v1_80 Control_Reg_NeoWrite (
        .control_1(Net_678),
        .control_2(Net_679),
        .control_3(Net_680),
        .control_0(Net_644),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Control_Reg_NeoWrite.Bit0Mode = 0;
    defparam Control_Reg_NeoWrite.Bit1Mode = 0;
    defparam Control_Reg_NeoWrite.Bit2Mode = 0;
    defparam Control_Reg_NeoWrite.Bit3Mode = 0;
    defparam Control_Reg_NeoWrite.Bit4Mode = 0;
    defparam Control_Reg_NeoWrite.Bit5Mode = 0;
    defparam Control_Reg_NeoWrite.Bit6Mode = 0;
    defparam Control_Reg_NeoWrite.Bit7Mode = 0;
    defparam Control_Reg_NeoWrite.BitValue = 1;
    defparam Control_Reg_NeoWrite.BusDisplay = 0;
    defparam Control_Reg_NeoWrite.ExtrReset = 0;
    defparam Control_Reg_NeoWrite.NumOutputs = 1;

	wire [0:0] tmpOE__P04_net;
	wire [0:0] tmpFB_0__P04_net;
	wire [0:0] tmpIO_0__P04_net;
	wire [0:0] tmpINTERRUPT_0__P04_net;
	electrical [0:0] tmpSIOVREF__P04_net;
	...
	cy_psoc3_pins_v1_10
		...
		P04
		 (.oe(tmpOE__P04_net),
		  .y({Net_591}),
		  .fb({tmpFB_0__P04_net[0:0]}),
		  .io({tmpIO_0__P04_net[0:0]}),
		  .siovref(tmpSIOVREF__P04_net),
		  .interrupt({tmpINTERRUPT_0__P04_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P04_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    StripLights_v1_3_2 StripLights (
        .rdy(Net_611),
        .S0(Net_591),
        .S1(Net_592),
        .S2(Net_593),
