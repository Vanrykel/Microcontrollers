// ======================================================================
// RCSC.v generated from TopDesign.cysch
// 01/05/2020 at 06:24
...
module top ;
	...
	wire [0:0] tmpOE__PWM_steering_net;
	wire [0:0] tmpIO_0__PWM_steering_net;
	wire [0:0] tmpINTERRUPT_0__PWM_steering_net;
	electrical [0:0] tmpSIOVREF__PWM_steering_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_steering
		 (.oe(tmpOE__PWM_steering_net),
		  .y({1'b0}),
		  .fb({Net_371}),
		  .io({tmpIO_0__PWM_steering_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_steering_net),
		  .interrupt({tmpINTERRUPT_0__PWM_steering_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_steering_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__STEERING_OUT_net;
	wire [0:0] tmpFB_0__STEERING_OUT_net;
	wire [0:0] tmpIO_0__STEERING_OUT_net;
	wire [0:0] tmpINTERRUPT_0__STEERING_OUT_net;
	electrical [0:0] tmpSIOVREF__STEERING_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		STEERING_OUT
		 (.oe(tmpOE__STEERING_OUT_net),
		  .y({Net_276}),
		  .fb({tmpFB_0__STEERING_OUT_net[0:0]}),
		  .io({tmpIO_0__STEERING_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__STEERING_OUT_net),
		  .interrupt({tmpINTERRUPT_0__STEERING_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__STEERING_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_2 readTimer (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__PWM_throttle_net;
	wire [0:0] tmpIO_0__PWM_throttle_net;
	wire [0:0] tmpINTERRUPT_0__PWM_throttle_net;
	electrical [0:0] tmpSIOVREF__PWM_throttle_net;

	cy_psoc3_pins_v1_10
		#(.id("60e6a7a7-18d4-43b5-8dae-dd3307f25358"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_throttle
		 (.oe(tmpOE__PWM_throttle_net),
		  .y({1'b0}),
		  .fb({Net_411}),
		  .io({tmpIO_0__PWM_throttle_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_throttle_net),
		  .interrupt({tmpINTERRUPT_0__PWM_throttle_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_throttle_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
