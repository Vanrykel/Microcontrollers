...
static void SPI_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void SPI_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        else if (SPI_SCB_MODE_SPI == mode)
        {
        ...
        #if (SPI_SCLK_PIN)
            hsiomSel[SPI_SCLK_PIN_INDEX] = SPI_SCLK_HSIOM_SEL_SPI;
        #endif /* (SPI_SCLK_PIN) */
            ...
            if (SPI_SPI_SLAVE == subMode)
            {
                ...
                hsiomSel[SPI_SS0_PIN_INDEX] = SPI_SS0_HSIOM_SEL_SPI;
        ...
        else /* UART */
        {
            ...
            else /* Standard or IrDA */
            {
                ...
                if (SPI_UART_MODE_STD == subMode)
                {
                    ...
                    #if (SPI_SCLK_PIN)
                        hsiomSel[SPI_SCLK_PIN_INDEX] = SPI_SCLK_HSIOM_SEL_UART;
                        pinsDm  [SPI_SCLK_PIN_INDEX] = SPI_PIN_DM_DIG_HIZ;
                    #endif /* (SPI_SCLK_PIN) */
                    }
                    ...
                    #if (SPI_SS0_PIN)
                        hsiomSel[SPI_SS0_PIN_INDEX] = SPI_SS0_HSIOM_SEL_UART;
                        pinsDm  [SPI_SS0_PIN_INDEX] = SPI_PIN_DM_STRONG;
    ...
    #if (SPI_SCLK_PIN)
        SPI_SET_HSIOM_SEL(SPI_SCLK_HSIOM_REG,
                                       SPI_SCLK_HSIOM_MASK,
                                       SPI_SCLK_HSIOM_POS,
                                       hsiomSel[SPI_SCLK_PIN_INDEX]);
    ...
    #if (SPI_SS0_PIN)
        SPI_SET_HSIOM_SEL(SPI_SS0_HSIOM_REG,
                                       SPI_SS0_HSIOM_MASK,
                                       SPI_SS0_HSIOM_POS,
                                       hsiomSel[SPI_SS0_PIN_INDEX]);
