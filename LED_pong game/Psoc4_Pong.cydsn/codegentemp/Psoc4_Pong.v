// ======================================================================
// Psoc4_Pong.v generated from TopDesign.cysch
// 12/16/2018 at 19:37
...
module top ;
	...
	cy_clock_v1_0
		#(.id("403a3555-a627-420c-b9a5-63db74c56d0a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpIO_0__Controller1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Controller1
		 (.oe(tmpOE__Controller1_net),
		  ...
		  .io({tmpIO_0__Controller1_net[0:0]}),
	...
	cy_psoc3_pins_v1_10
		...
		Controller2
		 (.oe(tmpOE__Controller2_net),
		  ...
		  .io({tmpIO_0__Controller2_net[0:0]}),
