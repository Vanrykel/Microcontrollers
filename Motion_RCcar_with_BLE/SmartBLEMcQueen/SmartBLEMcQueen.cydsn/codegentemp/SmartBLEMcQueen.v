// ======================================================================
// SmartBLEMcQueen.v generated from TopDesign.cysch
// 01/03/2020 at 15:40
...
module BLE_v3_50_0 (
	...
	cy_clock_v1_0
		#(.id("8db2e296-1dce-4e24-a51e-f4ca973b4ad7/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	wire [0:0] tmpOE__Speed_Motor_A_net;
	wire [0:0] tmpFB_0__Speed_Motor_A_net;
	wire [0:0] tmpIO_0__Speed_Motor_A_net;
	wire [0:0] tmpINTERRUPT_0__Speed_Motor_A_net;
	electrical [0:0] tmpSIOVREF__Speed_Motor_A_net;
	...
	cy_psoc3_pins_v1_10
		...
		Speed_Motor_A
		 (.oe(tmpOE__Speed_Motor_A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Speed_Motor_A_net[0:0]}),
		  .io({tmpIO_0__Speed_Motor_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Speed_Motor_A_net),
		  .interrupt({tmpINTERRUPT_0__Speed_Motor_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Speed_Motor_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Direction_Motor_A_net;
	wire [0:0] tmpFB_0__Direction_Motor_A_net;
	wire [0:0] tmpIO_0__Direction_Motor_A_net;
	wire [0:0] tmpINTERRUPT_0__Direction_Motor_A_net;
	electrical [0:0] tmpSIOVREF__Direction_Motor_A_net;

	cy_psoc3_pins_v1_10
		#(.id("c13334da-54f2-4388-b9d7-61ae0ce9b954"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Direction_Motor_A
		 (.oe(tmpOE__Direction_Motor_A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Direction_Motor_A_net[0:0]}),
		  .io({tmpIO_0__Direction_Motor_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Direction_Motor_A_net),
		  .interrupt({tmpINTERRUPT_0__Direction_Motor_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Direction_Motor_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Speed_Motor_B_net;
	wire [0:0] tmpFB_0__Speed_Motor_B_net;
	wire [0:0] tmpIO_0__Speed_Motor_B_net;
	wire [0:0] tmpINTERRUPT_0__Speed_Motor_B_net;
	electrical [0:0] tmpSIOVREF__Speed_Motor_B_net;

	cy_psoc3_pins_v1_10
		#(.id("204f5c7f-7002-4ae2-a63b-ac7365fa4480"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Speed_Motor_B
		 (.oe(tmpOE__Speed_Motor_B_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Speed_Motor_B_net[0:0]}),
		  .io({tmpIO_0__Speed_Motor_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Speed_Motor_B_net),
		  .interrupt({tmpINTERRUPT_0__Speed_Motor_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Speed_Motor_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Direction_Motor_B_net;
	wire [0:0] tmpFB_0__Direction_Motor_B_net;
	wire [0:0] tmpIO_0__Direction_Motor_B_net;
	wire [0:0] tmpINTERRUPT_0__Direction_Motor_B_net;
	electrical [0:0] tmpSIOVREF__Direction_Motor_B_net;

	cy_psoc3_pins_v1_10
		#(.id("30640f2f-4858-4b1e-b9a3-d388fd68a2dd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Direction_Motor_B
		 (.oe(tmpOE__Direction_Motor_B_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Direction_Motor_B_net[0:0]}),
		  .io({tmpIO_0__Direction_Motor_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Direction_Motor_B_net),
		  .interrupt({tmpINTERRUPT_0__Direction_Motor_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Direction_Motor_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    BLE_v3_50_0 BLE (
        .clk(Net_5),
        .pa_en(Net_6));

	wire [0:0] tmpOE__BLE_StatusLED_net;
	wire [0:0] tmpFB_0__BLE_StatusLED_net;
	wire [0:0] tmpIO_0__BLE_StatusLED_net;
	wire [0:0] tmpINTERRUPT_0__BLE_StatusLED_net;
	electrical [0:0] tmpSIOVREF__BLE_StatusLED_net;

	cy_psoc3_pins_v1_10
		#(.id("ff4db871-1cff-4042-961a-d0c049c84884"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BLE_StatusLED
		 (.oe(tmpOE__BLE_StatusLED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BLE_StatusLED_net[0:0]}),
		  .io({tmpIO_0__BLE_StatusLED_net[0:0]}),
		  .siovref(tmpSIOVREF__BLE_StatusLED_net),
		  .interrupt({tmpINTERRUPT_0__BLE_StatusLED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BLE_StatusLED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BLE_ConnectionLED_net;
	wire [0:0] tmpFB_0__BLE_ConnectionLED_net;
	wire [0:0] tmpIO_0__BLE_ConnectionLED_net;
	wire [0:0] tmpINTERRUPT_0__BLE_ConnectionLED_net;
	electrical [0:0] tmpSIOVREF__BLE_ConnectionLED_net;

	cy_psoc3_pins_v1_10
		#(.id("1a24de45-7a86-4e7b-baf9-487565eb9797"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BLE_ConnectionLED
		 (.oe(tmpOE__BLE_ConnectionLED_net),
		  .y({Net_8}),
		  .fb({tmpFB_0__BLE_ConnectionLED_net[0:0]}),
		  .io({tmpIO_0__BLE_ConnectionLED_net[0:0]}),
		  .siovref(tmpSIOVREF__BLE_ConnectionLED_net),
		  .interrupt({tmpINTERRUPT_0__BLE_ConnectionLED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BLE_ConnectionLED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_8 = ~Net_295;


	cy_clock_v1_0
		#(.id("a5298389-92c0-4ffd-8aee-c8e539f66440"),
		  .source_clock_id(""),
		  .divisor(0),
