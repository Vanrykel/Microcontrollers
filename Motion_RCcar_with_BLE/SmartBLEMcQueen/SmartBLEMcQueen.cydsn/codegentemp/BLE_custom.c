...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* BLE_CAR service */
    {
        0x000Cu, /* Handle of the BLE_CAR service */ 
        {
            ...
            /* BUTTON_LEFT characteristic */
            {
                0x0011u, /* Handle of the BUTTON_LEFT characteristic */ 
            ...
            /* BUTTON_RIGHT characteristic */
            {
                0x0014u, /* Handle of the BUTTON_RIGHT characteristic */ 
            ...
            /* BUTTON_FORWARD characteristic */
            {
                0x0017u, /* Handle of the BUTTON_FORWARD characteristic */ 
            ...
            /* BUTTON_BACKWARD characteristic */
            {
                0x001Au, /* Handle of the BUTTON_BACKWARD characteristic */ 
