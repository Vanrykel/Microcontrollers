    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    (uint8)'D', (uint8)'r', (uint8)'i', (uint8)'v', (uint8)'e',
...
const uint8 cyBle_attUuid128[][16u] = {
    /* rc_car */
    { 0x30u, 0xEDu, 0x13u, 0x0Au, 0xD6u, 0xE6u, 0xD2u, 0x82u, 0x68u, 0x4Fu, 0x3Eu, 0x08u, 0x00u, 0x31u, 0xE5u, 0x2Au },
    /* drive */
    { 0x31u, 0xEDu, 0x13u, 0x0Au, 0xD6u, 0xE6u, 0xD2u, 0x82u, 0x68u, 0x4Fu, 0x3Eu, 0x08u, 0x00u, 0x31u, 0xE5u, 0x2Au },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* rc_car UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* drive UUID */
    { 0x0001u, (void *)&cyBle_attValues[22] }, /* drive */
    { 0x0005u, (void *)&cyBle_attValues[23] }, /* Characteristic User Description */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x13u] = {
    ...
    { 0x0012u, 0x3100u /* drive                               */, 0x090A0101u /* rd,wr */, 0x0013u, {{0x0001u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0013u, 0x2901u /* Characteristic User Description     */, 0x01020001u /* rd    */, 0x0013u, {{0x0005u, (void *)&cyBle_attValuesLen[10]}} },
};
