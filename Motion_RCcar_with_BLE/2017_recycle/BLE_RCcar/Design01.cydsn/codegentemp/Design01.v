...
module BLE_v3_40_0 (
	...
	cy_clock_v1_0
		#(.id("83724473-7f06-4af9-8ca1-8a0e40c14909/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	wire [0:0] tmpOE__Forward_Pin_net;
	wire [0:0] tmpFB_0__Forward_Pin_net;
	wire [0:0] tmpIO_0__Forward_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Forward_Pin_net;
	electrical [0:0] tmpSIOVREF__Forward_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("f90d4512-5285-443f-9aed-04656890ab7b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Forward_Pin
		 (.oe(tmpOE__Forward_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Forward_Pin_net[0:0]}),
		  .io({tmpIO_0__Forward_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Forward_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Forward_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Forward_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_144 = ~Net_74;


	cy_clock_v1_0
		#(.id("f2018b87-8abf-47c0-a0e5-3dc276cf8d8b"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Reverse_Pin_net;
	wire [0:0] tmpFB_0__Reverse_Pin_net;
	wire [0:0] tmpIO_0__Reverse_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Reverse_Pin_net;
	electrical [0:0] tmpSIOVREF__Reverse_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("44951cfc-e96d-4390-924d-5552d7bef59d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Reverse_Pin
		 (.oe(tmpOE__Reverse_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Reverse_Pin_net[0:0]}),
		  .io({tmpIO_0__Reverse_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Reverse_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Reverse_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Reverse_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("ce015b4a-9bc1-4afe-84c5-8439ff20526d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3dc998e5-8fc9-4327-a88e-fc70d99f1049"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
