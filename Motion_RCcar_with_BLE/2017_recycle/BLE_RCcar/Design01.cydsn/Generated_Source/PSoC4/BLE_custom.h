...
#define CYBLE_RC_CAR_SERVICE_INDEX   (0x00u) /* Index of rc_car service in the cyBle_customs array */
#define CYBLE_RC_CAR_DRIVE_CHAR_INDEX   (0x00u) /* Index of drive characteristic */
#define CYBLE_RC_CAR_DRIVE_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */


#define CYBLE_RC_CAR_SERVICE_HANDLE   (0x0010u) /* Handle of rc_car service */
#define CYBLE_RC_CAR_DRIVE_DECL_HANDLE   (0x0011u) /* Handle of drive characteristic declaration */
#define CYBLE_RC_CAR_DRIVE_CHAR_HANDLE   (0x0012u) /* Handle of drive characteristic */
#define CYBLE_RC_CAR_DRIVE_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
