...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* BLE_Motor service */
    {
        0x0010u, /* Handle of the BLE_Motor service */ 
        {

            /* SPEED characteristic */
            {
                0x0012u, /* Handle of the SPEED characteristic */ 
            ...
            {
                0x0016u, /* Handle of the ACCELERATION characteristic */ 
            ...
            {
                0x001Au, /* Handle of the Direction characteristic */ 
            ...
            {
                0x001Eu, /* Handle of the Temperature characteristic */ 
            ...
            {
                0x0021u, /* Handle of the Current characteristic */ 
