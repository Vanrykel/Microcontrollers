...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_FAST_ADV_INT_MIN                  (0x008Cu)
    ...
    #define CYBLE_GAPP_CONNECTION_TIME_OUT          (0xFFFFu)
...
#define CYBLE_SCN_PKT_INDEX_BLUETOOTH_DEVICE_ADDRESS   (0x12u)
#define CYBLE_SCN_PKT_INDEX_ROLE   (0x1Bu)
