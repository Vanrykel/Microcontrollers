...
#define CYBLE_LEDCAPSENSE_LEFT_CHAR_INDEX   (0x00u) /* Index of left characteristic */
#define CYBLE_LEDCAPSENSE_LEFT_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
...
#define CYBLE_LEDCAPSENSE_RIGHT_CHAR_INDEX   (0x02u) /* Index of right characteristic */
#define CYBLE_LEDCAPSENSE_RIGHT_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CYBLE_LEDCAPSENSE_UP_CHAR_INDEX   (0x03u) /* Index of up characteristic */
#define CYBLE_LEDCAPSENSE_UP_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CYBLE_LEDCAPSENSE_DOWN_CHAR_INDEX   (0x04u) /* Index of down characteristic */
#define CYBLE_LEDCAPSENSE_DOWN_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */


#define CYBLE_LEDCAPSENSE_SERVICE_HANDLE   (0x0010u) /* Handle of ledcapsense service */
#define CYBLE_LEDCAPSENSE_LEFT_DECL_HANDLE   (0x0011u) /* Handle of left characteristic declaration */
#define CYBLE_LEDCAPSENSE_LEFT_CHAR_HANDLE   (0x0012u) /* Handle of left characteristic */
#define CYBLE_LEDCAPSENSE_LEFT_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
...
#define CYBLE_LEDCAPSENSE_RIGHT_DECL_HANDLE   (0x0018u) /* Handle of right characteristic declaration */
#define CYBLE_LEDCAPSENSE_RIGHT_CHAR_HANDLE   (0x0019u) /* Handle of right characteristic */
#define CYBLE_LEDCAPSENSE_RIGHT_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x001Au) /* Handle of Custom Descriptor descriptor */
#define CYBLE_LEDCAPSENSE_UP_DECL_HANDLE   (0x001Bu) /* Handle of up characteristic declaration */
#define CYBLE_LEDCAPSENSE_UP_CHAR_HANDLE   (0x001Cu) /* Handle of up characteristic */
#define CYBLE_LEDCAPSENSE_UP_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x001Du) /* Handle of Custom Descriptor descriptor */
#define CYBLE_LEDCAPSENSE_DOWN_DECL_HANDLE   (0x001Eu) /* Handle of down characteristic declaration */
#define CYBLE_LEDCAPSENSE_DOWN_CHAR_HANDLE   (0x001Fu) /* Handle of down characteristic */
#define CYBLE_LEDCAPSENSE_DOWN_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0020u) /* Handle of Custom Descriptor descriptor */
