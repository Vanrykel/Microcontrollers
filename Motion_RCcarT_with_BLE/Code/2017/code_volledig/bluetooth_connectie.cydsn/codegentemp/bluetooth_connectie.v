// ======================================================================
// bluetooth_connectie.v generated from TopDesign.cysch
// 12/12/2017 at 19:58
...
module BLE_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("c3b02505-aa52-4a96-95bc-1eb1b7638da7/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=50, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=99, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=pwm_rechts, CY_INSTANCE_SHORT_NAME=pwm_rechts, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=pwm_rechts, )
module PWM_v3_30_3 (
    reset,
    clock,
    tc,
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("95560014-ed44-40ec-b4d9-7f9f0151e7b0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    assign Net_104 = ~Net_122;


	cy_clock_v1_0
		#(.id("1a52a2c6-5e9f-4b6d-8a84-b422cc7227a1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("505050505.050505"),
		  .is_direct(0),
		  .is_digital(1))
		Clock_1
		 (.clock_out(Net_1474));
	...
	cy_psoc3_pins_v1_10
		#(.id("419d2aab-4e4f-45fb-955a-46fb4f28e018"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("58768be1-69c0-4001-8e2e-dc63a4b100cd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__DIRL_net;
	wire [0:0] tmpFB_0__DIRL_net;
	wire [0:0] tmpIO_0__DIRL_net;
	wire [0:0] tmpINTERRUPT_0__DIRL_net;
	electrical [0:0] tmpSIOVREF__DIRL_net;

	cy_psoc3_pins_v1_10
		#(.id("2374837b-c396-4ece-a656-24afc0b8bd93"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DIRL
		 (.oe(tmpOE__DIRL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DIRL_net[0:0]}),
		  .io({tmpIO_0__DIRL_net[0:0]}),
		  .siovref(tmpSIOVREF__DIRL_net),
		  .interrupt({tmpINTERRUPT_0__DIRL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIRL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DIRR_net;
	wire [0:0] tmpFB_0__DIRR_net;
	wire [0:0] tmpIO_0__DIRR_net;
	wire [0:0] tmpINTERRUPT_0__DIRR_net;
	electrical [0:0] tmpSIOVREF__DIRR_net;

	cy_psoc3_pins_v1_10
		#(.id("2946d2cf-2082-41ac-93c8-cf05e807b758"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DIRR
		 (.oe(tmpOE__DIRR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DIRR_net[0:0]}),
		  .io({tmpIO_0__DIRR_net[0:0]}),
		  .siovref(tmpSIOVREF__DIRR_net),
		  .interrupt({tmpINTERRUPT_0__DIRR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIRR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SPEEDL_net;
	wire [0:0] tmpFB_0__SPEEDL_net;
	wire [0:0] tmpIO_0__SPEEDL_net;
	wire [0:0] tmpINTERRUPT_0__SPEEDL_net;
	electrical [0:0] tmpSIOVREF__SPEEDL_net;

	cy_psoc3_pins_v1_10
		#(.id("939c34ab-b623-4162-ab36-12bcba6519b4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SPEEDL
		 (.oe(tmpOE__SPEEDL_net),
		  .y({Net_328}),
		  .fb({tmpFB_0__SPEEDL_net[0:0]}),
		  .io({tmpIO_0__SPEEDL_net[0:0]}),
		  .siovref(tmpSIOVREF__SPEEDL_net),
		  .interrupt({tmpINTERRUPT_0__SPEEDL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SPEEDL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SPEEDR_net;
	wire [0:0] tmpFB_0__SPEEDR_net;
	wire [0:0] tmpIO_0__SPEEDR_net;
	wire [0:0] tmpINTERRUPT_0__SPEEDR_net;
	electrical [0:0] tmpSIOVREF__SPEEDR_net;

	cy_psoc3_pins_v1_10
		#(.id("85c3fca1-9370-4cf0-91ca-ecf3d3a16e38"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SPEEDR
		 (.oe(tmpOE__SPEEDR_net),
		  .y({Net_329}),
		  .fb({tmpFB_0__SPEEDR_net[0:0]}),
		  .io({tmpIO_0__SPEEDR_net[0:0]}),
		  .siovref(tmpSIOVREF__SPEEDR_net),
		  .interrupt({tmpINTERRUPT_0__SPEEDR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SPEEDR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_2 pwm_links (
        .reset(Net_159),
        .clock(Net_1474),
        .tc(Net_2009),
        .pwm1(Net_2010),
        ...
        .ph1(Net_2018),
        .ph2(Net_2019));
    defparam pwm_links.Resolution = 8;

    PWM_v3_30_3 pwm_rechts (
        .reset(Net_159),
        .clock(Net_1474),
        .tc(Net_2031),
        .pwm1(Net_2032),
        ...
        .ph1(Net_2040),
        .ph2(Net_2041));
    defparam pwm_rechts.Resolution = 8;
	...
	cy_psoc3_pins_v1_10
		#(.id("b37e721c-f98b-4aca-92e5-09ee45cb8ba5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [2:0] tmpOE__Echo_net;
	wire [2:0] tmpFB_2__Echo_net;
	wire [2:0] tmpIO_2__Echo_net;
	wire [0:0] tmpINTERRUPT_0__Echo_net;
	electrical [0:0] tmpSIOVREF__Echo_net;

	cy_psoc3_pins_v1_10
		#(.id("3e9de932-3052-4878-b779-99916768f08e"),
		...
		Echo
		 (.oe(tmpOE__Echo_net),
		  .y({3'b0}),
		  .fb({tmpFB_2__Echo_net[2:0]}),
		  .io({tmpIO_2__Echo_net[2:0]}),
	...
	assign tmpOE__Echo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};
	...
	wire [0:0] tmpOE__encoderInputRight_net;
	wire [0:0] tmpIO_0__encoderInputRight_net;
	wire [0:0] tmpINTERRUPT_0__encoderInputRight_net;
	electrical [0:0] tmpSIOVREF__encoderInputRight_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		encoderInputRight
		 (.oe(tmpOE__encoderInputRight_net),
		  .y({1'b0}),
		  .fb({Net_2060}),
		  .io({tmpIO_0__encoderInputRight_net[0:0]}),
		  .siovref(tmpSIOVREF__encoderInputRight_net),
		  .interrupt({tmpINTERRUPT_0__encoderInputRight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__encoderInputRight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ledRight_net;
	wire [0:0] tmpFB_0__ledRight_net;
	wire [0:0] tmpIO_0__ledRight_net;
	wire [0:0] tmpINTERRUPT_0__ledRight_net;
	electrical [0:0] tmpSIOVREF__ledRight_net;

	cy_psoc3_pins_v1_10
		#(.id("1f72d692-6db6-450e-a979-e0c8dd533d99"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ledRight
		 (.oe(tmpOE__ledRight_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ledRight_net[0:0]}),
		  .io({tmpIO_0__ledRight_net[0:0]}),
		  .siovref(tmpSIOVREF__ledRight_net),
		  .interrupt({tmpINTERRUPT_0__ledRight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ledRight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__encoderInputLeft_net;
	wire [0:0] tmpIO_0__encoderInputLeft_net;
	wire [0:0] tmpINTERRUPT_0__encoderInputLeft_net;
	electrical [0:0] tmpSIOVREF__encoderInputLeft_net;

	cy_psoc3_pins_v1_10
		#(.id("81ba0551-12c1-43e1-a274-76a5ea8a7dde"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		encoderInputLeft
		 (.oe(tmpOE__encoderInputLeft_net),
		  .y({1'b0}),
		  .fb({Net_2061}),
		  .io({tmpIO_0__encoderInputLeft_net[0:0]}),
		  .siovref(tmpSIOVREF__encoderInputLeft_net),
		  .interrupt({tmpINTERRUPT_0__encoderInputLeft_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__encoderInputLeft_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ledLeft_net;
	wire [0:0] tmpFB_0__ledLeft_net;
	wire [0:0] tmpIO_0__ledLeft_net;
	wire [0:0] tmpINTERRUPT_0__ledLeft_net;
	electrical [0:0] tmpSIOVREF__ledLeft_net;

	cy_psoc3_pins_v1_10
		#(.id("d9655eba-bba5-4666-b3ce-d92c0678968d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ledLeft
		 (.oe(tmpOE__ledLeft_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ledLeft_net[0:0]}),
		  .io({tmpIO_0__ledLeft_net[0:0]}),
		  .siovref(tmpSIOVREF__ledLeft_net),
		  .interrupt({tmpINTERRUPT_0__ledLeft_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ledLeft_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ledForward_net;
	wire [0:0] tmpFB_0__ledForward_net;
	wire [0:0] tmpIO_0__ledForward_net;
	wire [0:0] tmpINTERRUPT_0__ledForward_net;
	electrical [0:0] tmpSIOVREF__ledForward_net;

	cy_psoc3_pins_v1_10
		#(.id("d2461c0b-09eb-4c40-91be-35bf50c02ae5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ledForward
		 (.oe(tmpOE__ledForward_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ledForward_net[0:0]}),
		  .io({tmpIO_0__ledForward_net[0:0]}),
		  .siovref(tmpSIOVREF__ledForward_net),
		  .interrupt({tmpINTERRUPT_0__ledForward_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ledForward_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
