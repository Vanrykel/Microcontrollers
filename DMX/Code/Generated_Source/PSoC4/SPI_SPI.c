...
void SPI_SpiPostEnable(void)
{
    ...
    if (SPI_CHECK_SPI_MASTER)
    {
        ...
        SPI_SET_HSIOM_SEL(SPI_SCLK_HSIOM_REG, SPI_SCLK_HSIOM_MASK,
                                       SPI_SCLK_HSIOM_POS, SPI_SCLK_HSIOM_SEL_SPI);
    #endif /* (SPI_SCLK_PIN) */

    #if (SPI_SS0_PIN)
        /* Set SCB SPI to drive output pin */
        SPI_SET_HSIOM_SEL(SPI_SS0_HSIOM_REG, SPI_SS0_HSIOM_MASK,
                                       SPI_SS0_HSIOM_POS, SPI_SS0_HSIOM_SEL_SPI);
    #endif /* (SPI_SS0_PIN) */
...
void SPI_SpiStop(void)
{
    ...
    if (SPI_CHECK_SPI_MASTER)
    {
        ...
        SPI_SET_HSIOM_SEL(SPI_SCLK_HSIOM_REG, SPI_SCLK_HSIOM_MASK,
                                       SPI_SCLK_HSIOM_POS, SPI_SCLK_HSIOM_SEL_GPIO);
    #endif /* (SPI_spi_sclk_PIN) */
        ...
        /* Set GPIO to drive output pin */
        SPI_SET_HSIOM_SEL(SPI_SS0_HSIOM_REG, SPI_SS0_HSIOM_MASK,
                                       SPI_SS0_HSIOM_POS, SPI_SS0_HSIOM_SEL_GPIO);
    #endif /* (SPI_spi_ss0_PIN) */
