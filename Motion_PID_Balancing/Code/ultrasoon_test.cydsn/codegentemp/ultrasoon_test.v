// ======================================================================
// ultrasoon_test.v generated from TopDesign.cysch
// 01/04/2020 at 15:57
...
module ADC_SAR_SEQ_P4_v2_50_4 (
	...
	cy_clock_v1_0
		#(.id("9e82ce4d-6845-4433-996e-f26a01edf8ba/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__ultrasoon_links_out_net;
	wire [0:0] tmpFB_0__ultrasoon_links_out_net;
	wire [0:0] tmpIO_0__ultrasoon_links_out_net;
	wire [0:0] tmpINTERRUPT_0__ultrasoon_links_out_net;
	electrical [0:0] tmpSIOVREF__ultrasoon_links_out_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		ultrasoon_links_out
		 (.oe(tmpOE__ultrasoon_links_out_net),
		  .y({Net_87}),
		  .fb({tmpFB_0__ultrasoon_links_out_net[0:0]}),
		  .io({tmpIO_0__ultrasoon_links_out_net[0:0]}),
		  .siovref(tmpSIOVREF__ultrasoon_links_out_net),
		  .interrupt({tmpINTERRUPT_0__ultrasoon_links_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ultrasoon_links_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_0 PWM_servo (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("f722f7e9-3685-4f01-9834-2f078eeccc14"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__ultrasoon_in_net;
	wire [0:0] tmpIO_0__ultrasoon_in_net;
	wire [0:0] tmpINTERRUPT_0__ultrasoon_in_net;
	electrical [0:0] tmpSIOVREF__ultrasoon_in_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		ultrasoon_in
		 (.oe(tmpOE__ultrasoon_in_net),
		  .y({1'b0}),
		  .fb({Net_210}),
		  .io({tmpIO_0__ultrasoon_in_net[0:0]}),
		  .siovref(tmpSIOVREF__ultrasoon_in_net),
		  .interrupt({tmpINTERRUPT_0__ultrasoon_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ultrasoon_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__ultrasoon_rechts_out_net;
	wire [0:0] tmpFB_0__ultrasoon_rechts_out_net;
	wire [0:0] tmpIO_0__ultrasoon_rechts_out_net;
	wire [0:0] tmpINTERRUPT_0__ultrasoon_rechts_out_net;
	electrical [0:0] tmpSIOVREF__ultrasoon_rechts_out_net;

	cy_psoc3_pins_v1_10
		#(.id("77b29b6f-9c9f-46b1-9c8f-14ab7fb57aa7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		ultrasoon_rechts_out
		 (.oe(tmpOE__ultrasoon_rechts_out_net),
		  .y({Net_87}),
		  .fb({tmpFB_0__ultrasoon_rechts_out_net[0:0]}),
		  .io({tmpIO_0__ultrasoon_rechts_out_net[0:0]}),
		  .siovref(tmpSIOVREF__ultrasoon_rechts_out_net),
		  .interrupt({tmpINTERRUPT_0__ultrasoon_rechts_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ultrasoon_rechts_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("efe16ab6-f266-4fe4-8993-bc90860065d3"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("00710007-5da7-4807-b9f5-61784f5b800a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("f0123a0b-4b10-4ccd-84cc-376ec0471d6d"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("541cadfa-e0c8-483f-a744-7fd8333988a1"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
